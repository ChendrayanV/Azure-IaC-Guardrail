...
<head>
  ...
  <style nonce="${nonce}">
    ...
    @media (max-width: 800px) { .columns { display: none; } .tag-row, .exception-row { grid-template-columns: 1fr; padding-bottom: 12px; border-bottom: 1px solid var(--vscode-widget-border); } }
  </style>
</head>
<body>
